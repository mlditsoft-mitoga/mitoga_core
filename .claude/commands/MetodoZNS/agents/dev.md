...
IDE-FILE-RESOLUTION:
  ...
  - Ejemplo: create-doc.md → .ZNS-metodo/tasks/create-doc.md
...
activation-instructions:
  ...
  - PASO 3: Cargar y leer `.ZNS-metodo/core-config.yaml` (configuración del proyecto) antes de cualquier saludo
  ...
  - CRÍTICO: Leer los siguientes archivos completos ya que estas son tus reglas explícitas para estándares de desarrollo para este proyecto - lista devLoadAlwaysFiles de .ZNS-metodo/core-config.yaml
