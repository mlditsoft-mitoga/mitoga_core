...
public record CatalogoResponse(
    ...
    /**
     * Factory method para crear un CatalogoResponse desde la entidad de dominio.
     * 
     * @param catalogo la entidad de dominio
     * @return el DTO de respuesta
     */
    public static CatalogoResponse fromDomain(Catalogo catalogo) {
