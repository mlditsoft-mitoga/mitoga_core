...
public record CatalogoTipo(String value) {
    ...
    /**
     * Factory method para crear un CatalogoTipo desde un código/string.
     * 
     * @param codigo el código del tipo de catálogo
     * @return un nuevo CatalogoTipo
     * @throws IllegalArgumentException si el código es inválido
     */
    public static CatalogoTipo fromCodigo(String codigo) {
        return new CatalogoTipo(codigo);
    }
