...
public class GlobalExceptionHandler {
        ...
        /**
         * Maneja excepciones de dominio (violaciones de reglas de negocio).
         * Genera respuesta 400 Bad Request o 409 Conflict según el tipo de excepción.
         * 
         * <p>
         * Las DomainExceptions representan errores de negocio que el usuario
         * puede corregir (ej: email duplicado, passwords no coinciden)
         * </p>
         *
         * @param ex      Excepción de dominio
         * @param request Request HTTP original
         * @return ResponseEntity con ErrorResponse y código 400/409
         */
        ...
        public ResponseEntity<ErrorResponse> handleDomainException(
                ...
                log.warn("Domain exception en {}: {} (status: {})",
                                request.getRequestURI(),
                                ex.getMessage(),
                                status.value());

                ErrorResponse response = ErrorResponse.clientError(
                                ex.getMessage(), // Mensaje del dominio (lenguaje ubicuo)
        ...
        /**
         * Determina el código HTTP apropiado para una excepción de dominio.
         * 
         * @param ex la excepción de dominio
         * @return el HttpStatus correspondiente
         */
        private HttpStatus determineStatusForDomainException(DomainException ex) {
                String exceptionName = ex.getClass().getSimpleName();

                // Excepciones que representan conflictos (recurso ya existe)
                if (exceptionName.contains("YaRegistrado") || exceptionName.contains("YaExiste")) {
                        return HttpStatus.CONFLICT; // 409
                }

                // Por defecto, las excepciones de dominio son errores de cliente
