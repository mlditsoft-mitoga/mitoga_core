# 📚 Índice de Documentación - Colección Postman Mitoga API

## 🎯 Quick Links

| Documento | Propósito | Tiempo de Lectura |
|-----------|-----------|-------------------|
| [README.md](./README.md) | **Guía completa de uso** | 20 min |
...
| [CHANGELOG.md](./CHANGELOG.md) | Historial de versiones | 3 min |
